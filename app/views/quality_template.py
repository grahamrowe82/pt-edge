"""Canonical quality MV template — single source of truth.

Every domain quality materialized view (mv_*_quality) is created from
this template.  Import it in migrations instead of copy-pasting SQL.

When adding columns to ai_repos that should appear in quality views,
update this template and create a migration that rebuilds all views.
"""
from string import Template

QUALITY_VIEW_SQL = Template("""
