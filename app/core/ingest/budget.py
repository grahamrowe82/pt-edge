...
Flow:
  1. acquire_budget("provider_name")  -- checks limits, enforces RPM, does NOT decrement
  2. make the HTTP request
  3. record_call("provider_name")     -- decrements consumed (only after call actually fired)
  4. record_success("provider_name")  -- clears backoff (if active)
  OR
  4. record_throttle("provider_name") -- sets exponential backoff (on 429)
"""
