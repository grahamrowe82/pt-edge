...
def generate_key() -> str:
    ...
    # Generate enough hex to fill the key length after the prefix
    hex_len = (settings.API_KEY_LENGTH - len(prefix)) // 2
    return prefix + secrets.token_hex(hex_len)
...
async def create_key(body: KeyRequest = KeyRequest(), request: Request = None):
    ...
    try:
        ...
        from app.core.api.auth import TIER_LIMITS
