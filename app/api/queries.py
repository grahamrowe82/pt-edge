...
# Maps domain slug to materialized view name. View names are derived from
# the canonical registry — never constructed from user input — so no SQL
# injection risk.
from app.config.domains import DOMAIN_VIEW_MAP as DOMAIN_VIEWS
