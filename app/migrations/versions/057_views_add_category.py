"""Add category column to all quality materialized views

Revision ID: 057
Revises: 056
Create Date: 2026-03-28

Recreates all 9 quality views with ar.category in the SELECT,
so category pages can be generated from the view data.
"""
...
def downgrade() -> None:
    pass  # Views would need to be recreated without category
