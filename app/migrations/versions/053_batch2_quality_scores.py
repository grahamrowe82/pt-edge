"""Add quality score views for voice-ai, diffusion, vector-db, embeddings, prompt-engineering

Revision ID: 053
Revises: 052
Create Date: 2026-03-28

Same 0-100 composite scoring formula as other domain quality views.
"""
...
scored AS (
    SELECT
        ar.id, ar.full_name, ar.name, ar.description,
...
SELECT id, full_name, name, description, stars, forks, language, license, archived,
